...
plot_heatmap = function(mat, row_subset, col_subset, title, file_prefix = "hmp_") {
  ...
  pheatmap(mat, color = cell_colors, border_color = NA, scale = "row", cluster_rows = TRUE, cluster_cols = FALSE,
